...
import { addCommaToCurrency } from "../../utils/digitCommaSeparation";
    ...
    <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded-lg p-8 gap-8">
      ...
      <div className="grid grid-rows-[1fr_2fr_1fr]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-end whitespace-nowrap">
          <div className="flex gap-1 items-center md:justify-between flex-wrap">
          ...
          <div className="flex flex-col items-end gap-1">
            <span className="font-bold">
              ₹{addCommaToCurrency(hotel.pricePerNight)} per night
            </span>
            <Link
              to={`/detail/${hotel._id}`}
